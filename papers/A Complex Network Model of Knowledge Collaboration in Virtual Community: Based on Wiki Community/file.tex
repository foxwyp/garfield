...
\begin{figure}[p]
  \centering
  \subfigure[a]{
     \scalebox{0.3}{\includegraphics{02-1}}
   } \quad
  \subfigure[b]{ 
       \scalebox{0.3}{\includegraphics{02-2}}
   } 
   \end{figure}
   \begin{figure}[p]
    \subfigure[c]{
     \scalebox{0.3}{\includegraphics{02-3}}
   } \quad
  \subfigure[d]{ 
       \scalebox{0.3}{\includegraphics{02-4}}
   } 
    \end{figure}
   \begin{figure}[p]
    \subfigure[e]{
     \scalebox{0.3}{\includegraphics{02-5}}
   } \quad
  \subfigure[f]{ 
       \scalebox{0.3}{\includegraphics{02-6}}
   } 
 \end{figure}
   \begin{figure}[p]
    \subfigure[g]{
     \scalebox{0.3}{\includegraphics{02-7}}
   } \quad
  \subfigure[h]{ 
       \scalebox{0.3}{\includegraphics{02-8}}
   } 
...
\begin{figure}[p]
  \centering
  \subfigure[a]{
     \scalebox{0.3}{\includegraphics{05-1}}
   } \quad
  \subfigure[b]{ 
       \scalebox{0.3}{\includegraphics{05-2}}
   } 
   \end{figure}
   \begin{figure}[p]
    \subfigure[c]{
     \scalebox{0.3}{\includegraphics{05-3}}
   } \quad
  \subfigure[d]{ 
       \scalebox{0.3}{\includegraphics{05-4}}
   } 
    \end{figure}
   \begin{figure}[p]
    \subfigure[e]{
     \scalebox{0.3}{\includegraphics{05-5}}
   } \quad
  \subfigure[f]{ 
       \scalebox{0.3}{\includegraphics{05-6}}
   } 
   \caption{Distribution of degree in odd months from 2004 to 2007}
\end{figure}
...
\begin{figure}[p]
  \centering
  \subfigure[a]{
     \scalebox{0.3}{\includegraphics{06-1}}
   } \quad
  \subfigure[b]{ 
       \scalebox{0.3}{\includegraphics{06-2}}
   } 
   \end{figure}
   \begin{figure}[p]
    \subfigure[c]{
     \scalebox{0.3}{\includegraphics{06-3}}
   } \quad
  \subfigure[d]{ 
       \scalebox{0.3}{\includegraphics{06-4}}
   } 
    \end{figure}
   \begin{figure}[p]
    \subfigure[e]{
     \scalebox{0.3}{\includegraphics{06-5}}
   } \quad
  \subfigure[f]{ 
       \scalebox{0.3}{\includegraphics{06-6}}
   } 
 \end{figure}
   \begin{figure}[p]
    \subfigure[g]{
     \scalebox{0.3}{\includegraphics{06-7}}
   } \quad
  \subfigure[h]{ 
       \scalebox{0.3}{\includegraphics{06-8}}
   } 
   \caption{Distribution of degree in odd months from 2004 to 2007}
\end{figure}
...
\begin{figure}[p]
  \centering
  \subfigure[a]{
     \scalebox{0.3}{\includegraphics{07-1}}
   } \quad
  \subfigure[b]{ 
       \scalebox{0.3}{\includegraphics{07-2}}
   } 
   \end{figure}
   \begin{figure}[p]
    \subfigure[c]{
     \scalebox{0.3}{\includegraphics{07-3}}
   } \quad
  \subfigure[d]{ 
       \scalebox{0.3}{\includegraphics{07-4}}
   } 
    \end{figure}
   \begin{figure}[p]
    \subfigure[e]{
     \scalebox{0.3}{\includegraphics{07-5}}
   } \quad
  \subfigure[f]{ 
       \scalebox{0.3}{\includegraphics{07-6}}
   } 
 \end{figure}
   \begin{figure}[p]
    \subfigure[g]{
     \scalebox{0.3}{\includegraphics{07-7}}
   } \quad
  \subfigure[h]{ 
       \scalebox{0.3}{\includegraphics{07-8}}
   } 
   \caption{Distribution of degree in odd months from 2004 to 2007}
\end{figure}
...
\bibliography{../../bibtex/elsevier,../../bibtex/emerald,../../bibtex/chinese,../../bibtex/jstor,../../bibtex/citeseer,../../bibtex/acm,../../bibtex/wiley,../../bibtex/book,../../bibtex/thesis,../../bibtex/ebsco,../../bibtex/old,../../bibtex/ieee,../../bibtex/internet,../../bibtex/ssrn,../../bibtex/apa,../../bibtex/blackwell,../../bibtex/sage,../../bibtex/springer,../../bibtex/MESharp,../../bibtex/taylor,../..arXiv}
\end{document}
